...
import { clearCart, minusCartItem, plusCartItem, removeCartItem } from "../redux/actions/cart-actions";
...
function Cart(props) {
  ...
  const onClearCart = () => {
    if (window.confirm('Are you sure you would like to remove all pizzas from the shopping cart?')) {
      dispatch(clearCart())
    }
  };
  const onRemoveItem = (id) => {
    if (window.confirm('Do you would like delete pizza?')) {
